...
def render_episode(
    ...
    while not done and step_count < max_steps:
        ...
        # Get action from policy (deterministic - use mode)
...
def run_experiment(_config: DictConfig) -> float:
    ...
    key_render = jax.random.PRNGKey(config.system.seed + 1000)  # Separate key for rendering
    ...
    for eval_step in range(config.arch.num_evaluation):
        ...
        trained_params = unreplicate_n_dims(learner_state.params.actor_params)
